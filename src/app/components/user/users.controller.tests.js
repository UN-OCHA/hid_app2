...
//     var scope, mockhrinfoService, mockList, countries, listQueryResponse, roles, rootScope, mockUser, mockUserService, mockGetText;
...
//       'x-total-count': 3
//     }
//     // initialUsers.$httpPromise = function () {
...
//         mockUserService.getCachedUsers = function () {}
//         mockUserService.getHttpUsers = function () {}

//         // spyOn(mockUser, 'query').and.callFake(function () {
//         //     var defer = $q.defer();
//         //   defer.resolve(initialUsers);
//         //   console.log('jkjl')
//         //   return defer.promise;
...
//         spyOn(mockUserService, 'getCachedUsers').and.callFake(function({}, callback){
//           callback(initialUsers);
//         });
//         spyOn(mockUserService, 'getHttpUsers').and.callFake(function({}, callback){
//           callback(initialUsers);
//         })
...
//         expect(mockUserService.getCachedUsers).toHaveBeenCalledWith(defaultParams, jasmine.any(Function));
//         expect(mockUserService.getHttpUsers).toHaveBeenCalledWith(initialUsers, jasmine.any(Function));
...
//         expect(mockUserService.getCachedUsers).toHaveBeenCalledWith(listParams, jasmine.any(Function));
//         expect(mockUserService.getHttpUsers).toHaveBeenCalledWith(initialUsers, jasmine.any(Function));
//         expect(scope.totalItems).toEqual(3);
//         expect(scope.users).toEqual(initialUsers);
//       });
...
//       it('should get the users and add them to the scope', function () {
//         expect(mockUserService.getCachedUsers).toHaveBeenCalledWith(searchParams, jasmine.any(Function));
//         expect(mockUserService.getHttpUsers).toHaveBeenCalledWith(initialUsers, jasmine.any(Function));
//         expect(scope.totalItems).toEqual(3);
//         expect(scope.users).toEqual(initialUsers);
//       });
...
//         scope.filter();
//         expect(mockUserService.getCachedUsers).toHaveBeenCalledWith({limit: 50, offset: 0, sort: 'job_title', country: 'hrinfo_loc_416'}, jasmine.any(Function));
//         expect(mockUserService.getHttpUsers).toHaveBeenCalledWith(initialUsers, jasmine.any(Function));
